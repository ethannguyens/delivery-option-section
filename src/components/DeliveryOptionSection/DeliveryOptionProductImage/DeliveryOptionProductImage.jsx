...
function DeliveryOptionProductImage({groupId, openProductPreview, productImage, index, quantity}){
  return (
    <div onClick={openProductPreview && openProductPreview} id={`DeliveryOptionProductImage-${index}`} className="DeliveryOptionProductImage">
      <img className="DeliveryOptionProductImage-img" group-id={groupId} item-index={index} alt={productImage[0].imageType} src={`https://${productImage[0].imageUrl}`} />
